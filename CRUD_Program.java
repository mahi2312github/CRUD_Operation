...
public class CRUD_Test {
	...
	public static void main(String[] args) {
		CIUD_Test objTest = new CRUD_Test();
	      objTest.create("1", "Amruta Burse", "1999-05-23", "2022-01-21");
		  objTest.create("2", "Anjali Burse", "2002-04-12", "2022-01-23");
		  objTest.read("1");
		  objTest.update("3", "3", "Shivani Kaoushlye", "1999-11-26","1999-12-1");
		  objTest.delete("3");
	}
